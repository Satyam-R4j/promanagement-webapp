    ...
    return res
        ...
        .json(
            new ApiResponse(
                200,
                { user: createdUser },
                "User registered successfully and verification email has been send to your mail"
            )
        );
});
...
const verifyEmail = asyncHandler(async (req, res) => {
    ...
    const user = await User.findOne({
        ...
        emailVerificationExpiry: { $gt: Data.now() },
    });
...
const forgotPasswordRequest = asyncHandler(async (req, res) => {
    ...
    await sendEmail({
        ...
        mailGenContent: forgotPasswordGenContent(
            user.username,
    ...
    return res
        ...
        .json(
            new ApiResponse(
                200,
                {},
                "Password reset mail has been sent to you mail"
            )
        );
});
